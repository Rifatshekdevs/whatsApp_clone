...
class _NewsFragmentState extends State<NewsFragment> {
  ...
  void initState() {
    ...
    if (Common.newsUrl == "") {
      Common.newsUrl = "https://www.zappkingmedia.com/mobile.php/news/";
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(children: [
        InAppWebView(
          key: webViewKey,
          initialUrlRequest: URLRequest(url: Uri.parse(Common.newsUrl)),
          ...
          shouldOverrideUrlLoading: (controller, navigationAction) async {
            ...
            if (![
              ...
              if (await canLaunch(Common.newsUrl)) {
                // Launch the App
                await launch(Common.newsUrl);
